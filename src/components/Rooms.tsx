...
import { Bed, Users, Maximize, Wifi, Wind, Tv } from "lucide-react";
          ...
          {rooms.map((room, i) => (
            ...
            >
              ...
              <div className="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                ...
                <button
                  onClick={onBookClick}
                  className="self-start bg-emerald-700 hover:bg-emerald-800 text-white px-8 py-3 rounded-full text-sm font-semibold tracking-wide transition-all font-[family-name:var(--font-lato)]"
                >
                  Book This Room
                </button>
              </div>
